...
<div class="wrap-title-page">
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <h1 class="ui-title-page">Form Add New Soal</h1>
      </div>
    </div>
  </div>
<!-- end container--> 
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <form class="form-contact ui-form" action="<?= Url::to(['/course/uploadsoal']) ?>" method="post" enctype="multipart/form-data">
                    <div class="row">


                        <?php 
                            $bab = Bab::find()
                              ->where('id_bab = :id', [':id' => $id_bab])
                              ->one();
                        ?>

                        <input type="hidden" class="form-control" name="id_pelajaran" value="<?= $bab['id_pelajaran_bab'] ?>"></input>
                        <input type="hidden" class="form-control" name="id_bab" value="<?= $id_bab ?>"></input>

                        <div class="col-xs-8">
                            <input type="text" class="form-control" name="judul" required placeholder="Judul Soal"></input>
                        </div>
