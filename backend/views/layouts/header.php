...
<header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-mini"><b>PENSinau</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>PENSinau</b> Administrator</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
					       <?= Html::img('@web/img/user2-160x160.png', ['class' => 'user-image', 'alt'=>'User Image']) ?>
